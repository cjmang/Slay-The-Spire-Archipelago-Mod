...
public class CharacterManager {
    ...
    public void markUnrecognziedCharacters()
    {
        ...
        List<String> names = getCharacters().keySet().stream()
                .filter(n -> CardCrawlGame.characterManager.getAllCharacters().stream().noneMatch(o -> o.chosenClass.name().equalsIgnoreCase(n)))
    ...
    private void selectCharacter(CharacterConfig config)
    {
        ...
        locationTracker.scoutAllLocations(ctx.getSlotData(), currentCharacterConfig);
